...
Итак, идея, по-видимому,  нереализуема из-за того, что слишком много людей могут предлагать свои алгоритмы для одной и той же цели. Т е в одну цель могут прилететь сотни алгоритмов её достижения, и я не знаю, что с этим делать...
